...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  def configure() {
    ...
    bind[AssignmentService].to[AssignmentServiceImpl]
    bind[AssignmentDAO].to[AssignmentDAOImpl]
    bind[StudyService].to[StudyServiceImpl]
    bind[StudyDAO].to[StudyDAOImpl]
