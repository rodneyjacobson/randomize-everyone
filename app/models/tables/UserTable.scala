...
class UserTable(tag: Tag) extends Table[DbUser](tag, "users") {
  ...
  def netID: Rep[Option[String]] = column[Option[String]]("full_name")
  ...
  override def * : ProvenShape[DbUser] = (userID, firstName, lastName, netID, email, avatarURL, activated) <> (DbUser.tupled, DbUser.unapply)
